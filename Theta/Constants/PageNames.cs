...
namespace Theta.Constants
{
    static class PageNames
    {
        ...
        public static string FilterPopupPage = nameof(Theta.Pages.PopupPages.FilterPopupPage);
        public static string MenuPopupPage = nameof(Theta.Pages.PopupPages.MenuPopupPage);
    }
}
